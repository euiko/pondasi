...
#define PONDASI_META_NAMEOF_PREFIX_GCC \
  "constexpr std::string_view pondasi::detail::nameOf() [with T = "
#define PONDASI_META_NAMEOF_SUFFIX_GCC \
  "; std::string_view = std::basic_string_view<char>"
#define PONDASI_META_NAMEOF_FUNCTION_GCC __PRETTY_FUNCTION__


#define PONDASI_META_NAMEOF_PREFIX_CLANG \
  "std::string_view pondasi::detail::nameOf() [T = "
...
#ifndef __clang__
  // gcc compiler
  #define PONDASI_META_NAMEOF_PREFIX PONDASI_META_NAMEOF_PREFIX_GCC
  #define PONDASI_META_NAMEOF_SUFFIX PONDASI_META_NAMEOF_SUFFIX_GCC
  #define PONDASI_META_NAMEOF_FUNCTION PONDASI_META_NAMEOF_FUNCTION_GCC
#else
  // clang compiler
